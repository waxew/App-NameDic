...
در نسخه 1.1.1 منبع MIT `mohammadhejazirad/persian-names` نیز با parser متنی مستقل به رأی‌گیری جنسیت و پوشش نام‌ها اضافه شده است. کد upstream اجرا نمی‌شود و فقط ثابت‌های متنی generated-data خوانده می‌شوند.
